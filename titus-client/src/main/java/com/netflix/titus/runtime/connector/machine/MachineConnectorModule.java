...
public class MachineConnectorModule extends AbstractModule {
    ...
    @Provides
    @Singleton
    public ReactorMachineServiceStub getReactorComputeServiceStub(GrpcToReactorClientFactory factory,
                                                                  @Named(MANAGED_CHANNEL_NAME) Channel channel) {
        return factory.apply(MachineServiceGrpc.newStub(channel), ReactorMachineServiceStub.class, MachineServiceGrpc.getServiceDescriptor());
    }
}
