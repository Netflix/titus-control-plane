...
public class K8ConnectorConfigurationBean implements K8ConnectorConfiguration {

    private final Environment environment;
    private final String prefix;

    public K8ConnectorConfigurationBean(Environment environment, String prefix) {
