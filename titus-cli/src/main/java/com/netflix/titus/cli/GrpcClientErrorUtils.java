...
public class GrpcClientErrorUtils {
    ...
    public static <STUB extends AbstractStub<STUB>> STUB attachCallHeaders(STUB client) {
        ...
        metadata.put(V3HeaderInterceptor.CALLER_ID_KEY, "titusCLI");
        metadata.put(V3HeaderInterceptor.CALL_REASON_KEY, "Titus operations request");
    ...
    public static void printDetails(StatusRuntimeException error) {
        ...
        com.netflix.titus.runtime.common.grpc.GrpcClientErrorUtils.getStatus(error).getDetailsList().forEach(GrpcClientErrorUtils::print);
    }
