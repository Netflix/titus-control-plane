...
public abstract class CommonAbstractTitusGrpcServer {

    private static final Logger logger = LoggerFactory.getLogger(CommonAbstractTitusGrpcServer.class);

    private final CommonGrpcEndpointConfiguration configuration;
    ...
    protected CommonAbstractTitusGrpcServer(CommonGrpcEndpointConfiguration configuration,
