 ...
 */
@Singleton
public class ClusterRemovableInstanceGroupAgentRemover {
    private static final Logger logger = LoggerFactory.getLogger(ClusterRemovableInstanceGroupAgentRemover.class);
    private static final String METRIC_ROOT = METRIC_CLUSTER_OPERATIONS + "clusterRemovableInstanceGroupAgentRemover.";
