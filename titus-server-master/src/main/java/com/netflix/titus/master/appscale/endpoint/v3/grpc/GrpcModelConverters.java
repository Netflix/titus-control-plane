...
import static com.netflix.titus.api.appscale.model.PolicyType.StepScaling;
import static com.netflix.titus.api.appscale.model.PolicyType.TargetTrackingScaling;
...
public final class GrpcModelConverters {
    ...
    private static CustomizedMetricSpecification toCustomizedMetricSpecification(com.netflix.titus.api.appscale.model.CustomizedMetricSpecification customizedMetricSpec) {
    ...
    private static MetricDimension toMetricDimension(com.netflix.titus.api.appscale.model.MetricDimension metricDimension) {
    ...
    private static PredefinedMetricSpecification toPredefinedMetricSpecification(com.netflix.titus.api.appscale.model.PredefinedMetricSpecification predefinedMetricSpec) {
