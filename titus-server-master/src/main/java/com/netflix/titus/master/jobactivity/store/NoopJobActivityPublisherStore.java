...
/**
 * This implementation of a {@link JobActivityPublisherStore} is an noop implementation for default use.
 */
@Singleton
public class NoopJobActivityPublisherStore implements JobActivityPublisherStore {
