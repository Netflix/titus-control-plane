...
public class JobActivityModule extends AbstractModule {
    ...
    @Provides
    @Singleton
    public JobActivityPublisherConfiguration getJobActivityPublisherConfiguration(ConfigProxyFactory factory) {
        return factory.newProxy(JobActivityPublisherConfiguration.class);
    }
}
