...
public class AgentResourceCacheFunctions {
    ...
    public static AgentResourceCacheInstance createInstance(String hostname, TaskRequest request, long timestamp) {
        ConsumeResult consumeResult = CollectionsExt.first(request.getAssignedResources().getConsumedNamedResources());
