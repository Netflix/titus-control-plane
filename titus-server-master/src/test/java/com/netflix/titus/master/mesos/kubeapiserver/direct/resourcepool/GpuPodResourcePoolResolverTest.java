...
public class GpuPodResourcePoolResolverTest {
    ...
    private final DirectKubeConfiguration configuration = Archaius2Ext.newConfiguration(DirectKubeConfiguration.class, config);
    ...
    public void testGpuJob() {
        config.setProperty("titusMaster.directKube.gpuResourcePoolNames", "gpu1,gpu2");
