...
public class JobCriteriaQueryTest extends BaseIntegrationTest {
    ...
    private void testFindJobAndTaskByJobIds(boolean v2Mode) throws Exception {
        ...
        assertCellDecoration(itemsList.get(0).getJobDescriptor());
    ...
    private void testSearchByJobType(boolean v2Mode) throws Exception {
        ...
        assertCellDecoration(batchQueryJobsItem.getJobDescriptor());
        ...
        assertCellDecoration(serviceQueryJobsItem.getJobDescriptor());
    ...
    public void testSearchByJobState() throws Exception {
        ...
        assertCellDecoration(acceptedJobQueryResultItem.getJobDescriptor());
        ...
        assertCellDecoration(killInitJobQueryResultItem.getJobDescriptor());
    ...
    private void testSearchByTaskState(String taskState, String expectedJobId, String expectedTaskId) {
        ...
        assertCellDecoration(jobQueryResultItem.getJobDescriptor());
    ...
    private void testSearchByAttributeValue(JobDescriptor<BatchJobExt> jobDescriptor1,
        ...
        for (Triple<String, String, String> next : attributeValue1Value2Triples) {
            ...
            assertCellDecoration(jobQueryResult1Item.getJobDescriptor());
            ...
            assertCellDecoration(jobQueryResult2Item.getJobDescriptor());
    ...
    public void testFieldsFiltering() throws Exception {
        ...
        assertCellDecoration(foundJobDescriptor); // Always present
