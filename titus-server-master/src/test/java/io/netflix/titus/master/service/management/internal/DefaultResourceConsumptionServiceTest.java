...
import io.netflix.titus.master.service.management.ResourceConsumptionEvents.ResourceConsumptionEvent;
...
import static io.netflix.titus.master.service.management.internal.ConsumptionModelGenerator.findEvent;
...
public class DefaultResourceConsumptionServiceTest {
    ...
    public void testUndefinedCapacityGroupNameEvents() throws Exception {
        ...
        Optional<CapacityGroupUndefinedEvent> event = findEvent(events, CapacityGroupUndefinedEvent.class, NOT_DEFINED_CAPACITY_GROUP);
    ...
    public void testRemovedCapacityGroupNameEvents() throws Exception {
        ...
        generator.removeCapacityGroup(CRITICAL_SLA_1.getAppName());
        lastEvaluation.set(generator.getEvaluation());
        testScheduler.advanceTimeBy(DefaultResourceConsumptionService.UPDATE_INTERVAL_MS, TimeUnit.MILLISECONDS);
        ...
        assertThat(newEvents.get(0).getCapacityGroup()).isEqualTo(CRITICAL_SLA_1.getAppName());
    }
