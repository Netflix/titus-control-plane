...
public class DefaultOrderTest {
    ...
    private static final DefaultOrder<Character, String, SampleItem, String> EMPTY_INDEX = DefaultOrder.newEmpty(SPEC);

    @Test
    public void testAdd() {
        // Initial
        DefaultOrder<Character, String, SampleItem, String> index = EMPTY_INDEX.add(newItems("a1", "#a1", "a2", "#a2", "b1", "#b1"));
    ...
    public void testRemove() {
        DefaultOrder<Character, String, SampleItem, String> index = EMPTY_INDEX.add(
