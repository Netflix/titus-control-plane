...
public class DefaultReconciliationFrameworkTest {
    ...
    private final Function<EntityHolder, ReconciliationEngine<String, SimpleReconcilerEvent>> engineFactory = mock(Function.class);
    ...
    private final DefaultReconciliationFramework<String, SimpleReconcilerEvent> framework = new DefaultReconciliationFramework<>(
            engineFactory,
            IDLE_TIMEOUT_MS,
            ACTIVE_TIMEOUT_MS,
            indexComparators,
