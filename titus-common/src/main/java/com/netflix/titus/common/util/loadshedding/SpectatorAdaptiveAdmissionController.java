...
public class SpectatorAdaptiveAdmissionController extends SpectatorAdmissionController implements AdaptiveAdmissionController {

    public SpectatorAdaptiveAdmissionController(AdaptiveAdmissionController delegate, TitusRuntime titusRuntime) {
        super(delegate, titusRuntime);
    }
