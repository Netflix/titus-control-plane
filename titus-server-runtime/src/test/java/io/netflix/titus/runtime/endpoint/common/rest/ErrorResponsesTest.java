...
import io.netflix.titus.runtime.endpoint.common.rest.ErrorResponses.StackTraceRepresentation;
import org.junit.Test;

import static io.netflix.titus.runtime.endpoint.common.rest.ErrorResponse.newError;
...
public class ErrorResponsesTest {
    ...
    public void testBuildOfGenericException() throws Exception {
        List<StackTraceRepresentation> mappedError;
        try {
    ...
    public void testBuildOfJacksonWithInvalidType() throws Exception {
        ...
        List<StackTraceRepresentation> mappedError = null;
        try {
    ...
    public void testBuildOfJacksonWithInvalidPropertyName() throws Exception {
        ...
        StackTraceRepresentation stackTrace = mappedError.get(0);
    ...
    public void testBuildOfThreadContext() throws Exception {
        ErrorResponse errorResponse = newError(500).threadContext().build();
