...
@Singleton
public class GrpcClusterMembershipNameResolverFactory extends NameResolver.Factory {
    ...
    public NameResolver newNameResolver(URI targetUri, Attributes params) {
        ...
        return new GrpcClusterMembershipLeaderNameResolver(configuration, resolver, addressSelector);
    }
