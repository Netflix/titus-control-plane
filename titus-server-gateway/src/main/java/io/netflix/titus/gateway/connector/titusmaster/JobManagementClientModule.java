...
public class JobManagementClientModule extends AbstractModule {
    ...
    public static final String NAME = "jobManagementService";
    ...
    @Provides
    @Singleton
    JobManagementServiceGrpc.JobManagementServiceStub jobManagementClient(final @Named(NAME) Channel channel) {
