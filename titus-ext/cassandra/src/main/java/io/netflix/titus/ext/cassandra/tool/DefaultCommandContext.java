...
public class DefaultCommandContext implements CommandContext {
    ...
    private final AsyncCassandraExecutor executor;

    public DefaultCommandContext(CommandLine commandLine) {
        List<String> ips = StringExt.splitByComma(commandLine.getOptionValue("t"));
        ...
        this.executor = new AsyncCassandraExecutor(session, PAGE_SIZE, SPLIT);
    }
    ...
    @Override
    public AsyncCassandraExecutor getCassandraExecutor() {
        return executor;
    }
}
