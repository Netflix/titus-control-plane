...
import com.netflix.titus.ext.jooqflyway.jobactivity.JooqResource;
...
public class JooqJobActivityPublisherStoreTestOld {
    private final static Logger logger = LoggerFactory.getLogger(JooqJobActivityPublisherStoreTestOld.class);
