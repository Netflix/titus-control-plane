...
public class K8ClusterState {
    ...
    public K8ClusterState(ClusterMember initial, Clock clock) {
        this.clock = clock;
    ...
    public K8ClusterState setLocalClusterMemberRevision(ClusterMembershipRevision<ClusterMember> localMemberRevision) {
        return toBuilder()
    ...
    public K8ClusterState processMembershipEventStreamEvent(ClusterMembershipChangeEvent event) {
    ...
    public K8ClusterState processLeaderElectionEventStreamEvent(LeaderElectionChangeEvent event) {
