...
class StubbedEvictionOperations implements EvictionOperations {
    ...
    public Mono<Void> terminateTask(String taskId, String reason, String callerId) {
        return deferMono(() -> {
            ...
            jobOperations.killTask(taskId, false, false, V3JobOperations.Trigger.Eviction, CallMetadata.newBuilder().withCallReason("Eviction").withCallerId("test").build()).block();
