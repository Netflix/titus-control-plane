...
public class JobUpdateEvent extends JobEvent {
    ...
    public JobUpdateEvent(EventType eventType, TitusModelUpdateAction updateAction, Optional<Job> job, Optional<Job> previousJobVersion, Optional<Throwable> error) {
