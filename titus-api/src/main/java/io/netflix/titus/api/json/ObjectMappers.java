...
import io.netflix.titus.api.jobmanager.store.mixin.DefaultMigrationPolicyMixin;
...
public class ObjectMappers {
    ...
    private static ObjectMapper createStoreMapper() {
        ...
        objectMapper.addMixIn(DefaultMigrationPolicy.class, DefaultMigrationPolicyMixin.class);
