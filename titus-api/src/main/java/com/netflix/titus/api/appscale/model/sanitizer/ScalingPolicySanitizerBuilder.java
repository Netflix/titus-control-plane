...
public class ScalingPolicySanitizerBuilder {

    public static final String SCALING_POLICY_SANITIZER = "scalingPolicySanitizer";

    private final EntitySanitizerBuilder sanitizerBuilder = EntitySanitizerBuilder.stdBuilder();

    public EntitySanitizer build() {
        return sanitizerBuilder.registerBean("asserts", new ScalingPolicyAssertions()).build();
    }
}
