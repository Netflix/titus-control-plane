...
public abstract class DisruptionBudgetMixIn {
    @JsonCreator
    public DisruptionBudgetMixIn(@JsonProperty("disruptionBudgetPolicy") DisruptionBudgetPolicy disruptionBudgetPolicy,
                                 @JsonProperty("disruptionBudgetRate") DisruptionBudgetRate disruptionBudgetRate,
                                 @JsonProperty("timeWindows") List<TimeWindow> timeWindows,
                                 @JsonProperty("containerHealthProviders") List<ContainerHealthProvider> containerHealthProviders) {
    }
}