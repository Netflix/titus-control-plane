...
public abstract class TimeWindowMixIn {

    @JsonCreator
    protected TimeWindowMixIn(@JsonProperty("days") List<Day> days,
                              @JsonProperty("hourlyTimeWindows") List<HourlyTimeWindow> hourlyTimeWindows,
